...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.follow-toggle-button').each(function (i, e) {
  ...
  button.click(function () {
    ...
    var eventuser = button.data('eventuser-id');
    var isFollowed = parseInt(button.data('isfollowed'));
    var isFollowed_next = 1 - isFollowed;

    if (isFollowed) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post("/".concat(eventuser, "/unfollow/").concat(viewuser), {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post("/".concat(eventuser, "/follow/").concat(viewuser), {
        isFollowed: isFollowed_next
      }, function (data) {
        button.data('isfollowed', data.isFollowed);
        var buttonLabels = ['フォローする', 'フォローしています'];
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.noAuthenticatedFollowButton').each(function (i, e) {
  var button = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e);
  button.click(function () {
    location.href = "/login";
  });
